...
const seed = {
  ...
  exercises: [
    ...
    },
    {
      ...
      technique: "Мягкие колени, таз уходит назад, спина нейтральна, вес идет близко к ногам.",
      mistakes: "Округление спины, слишком глубокий наклон без контроля, рывок с пола.",
      alternatives: ["Гиперэкстензия", "Сгибание ног лёжа"]
    },
    {
      ...
      type: "базовое",
      equipment: "гантели, скамья",
      technique: "Передняя стопа устойчива, корпус слегка наклонен, колено идет по линии стопы.",
      mistakes: "Падение таза, завал колена внутрь, слишком короткая амплитуда.",
      alternatives: ["Жим ногами", "Выпады"]
    },
    {
      id: "ex-back-extension",
      name: "Гиперэкстензия",
      muscle: "ягодицы/разгибатели спины",
      type: "базовое",
      equipment: "римский стул",
      technique: "Поднимай корпус за счет ягодиц и задней поверхности бедра, не переразгибай поясницу.",
      mistakes: "Резкое переразгибание, работа только поясницей, отсутствие контроля вниз.",
      alternatives: ["Румынская тяга", "Ягодичный мост"]
    },
    {
      id: "ex-face-pull",
      name: "Face pull",
      muscle: "задняя дельта/ротаторы плеча",
      type: "мобилити",
      equipment: "канат на блоке",
      technique: "Тяни канат к лицу, локти высоко, лопатки двигаются свободно, темп спокойный.",
      mistakes: "Слишком большой вес, прогиб поясницы, тяга только руками.",
      alternatives: ["Обратная разводка", "Разводка в наклоне"]
    },
    {
      id: "ex-ez-curl",
